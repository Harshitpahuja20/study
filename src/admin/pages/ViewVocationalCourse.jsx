                    ...
                    <tr key={data._id}>
                      ...
                      <td className="py-3">
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            navigate("/admin/vocationalCourse/subject/details", {
                              state: {
                                id: data?._id,
                                name: data?.name,
                              },
...
export default ViewVocationalCourse;
