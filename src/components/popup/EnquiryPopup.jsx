...
const EnquiryPopupModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.phoneNumber)
      return toast.warning("phoneNumber Number is required");
  ...
  return (
    ...
    >
      <Modal.Body className="d-flex p-0 position-relative">
        <button
          onClick={handleClose}
          className="position-absolute top-0 end-0 m-1 me-1 border-0 bg-transparent"
          style={{ zIndex: 10 }}
          aria-label="Close"
        >
        ...
        <Row>
          ...
          <div className="bg-white col-lg-6 col-12 p-4 ">
