          ...
          <Col md={8}>
            <div className="d-flex align-items-center gap-2">
              <h5 className="ff_r fw-bold mb-0">
                Top iti in India Admission 2025 - 26, Important Topics, Course &
                Fees Details
              </h5>
                ...
                <div className="d-sm-flex align-items-center gap-3">
                  ...
                  <div className="mt-3 mt-sm-0">
                    <p className="mb-1 fw-semibold">
                      Admissions Open for All Courses 2025 - 26
                    </p>
                    <h6 className="mb-1 text-primary fw-bold">{uni.name}</h6>
...
export default TopITIHeroSection;
