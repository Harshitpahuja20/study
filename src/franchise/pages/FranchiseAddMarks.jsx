...
// import { getsubjects } from "../services/FranchiseSubjects.service";
import { toast } from "react-toastify";
// import { addStudentMarks } from "../services/FranchiseStudent.service";

const FranchiseAddMarks = () => {
  ...
  const fetchData = async () => {
    setDataLoading(true);
    // const response = await addStudentMarks(courseId);
...
export default FranchiseAddMarks;
