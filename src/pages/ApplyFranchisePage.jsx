...
const ApplyFranchisePage = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.instituteName.trim())
      return toast.warning("Institute Name is required!");
    if (!formData.directorName.trim())
      return toast.warning("Director Name is required!");
          ...
          <Row className=" justify-content-between">
            <Col md={5}>
              ...
              <p className="mt-md-4 mt-3 fw-normal text-white ff_r mb-0">
                Register your franchise today and get started with a trusted
                brand. Step into success with full support and a growing network
                behind you.
              </p>
            </Col>
            <Col md={6} className="mt-5 mt-md-0">
              ...
              <div>
                <button
                  className="btn border border-light px-4 py-2 text-white mt-4 fs-6 rounded rounded-5"
